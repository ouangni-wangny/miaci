<a {{ $attributes->merge()
            ->class([
                'justify-center text-center items-center inline-flex space-x-2 rounded-xl border shadow-sm px-4 py-2 text-sm font-medium focus:ring focus:ring-opacity-50' => $isTailwind && ($attributes['default-styling'] ?? true),
