...
<input x-cloak
    {{
        $attributes->merge($checkboxAttributes)->class([
            'border-gray-300 text-primary-600 focus:border-primary-300 focus:ring-primary-200 dark:bg-gray-900 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600 dark:focus:bg-gray-600' => ($isTailwind) && ($checkboxAttributes['default-colors'] ?? ($checkboxAttributes['default'] ?? true)),
