    ...
    <select wire:model.live="perPage" id="{{ $tableName }}-perPage"
        {{ 
            ...
            ->class([
                ...
                'block w-full rounded-xl shadow-sm transition duration-150 ease-in-out sm:text-sm sm:leading-5 focus:ring focus:ring-opacity-50' => $isTailwind && $this->getPerPageFieldAttributes()['default-styling'],
                'border-gray-300 focus:border-primary-300 focus:ring-primary-200 dark:bg-gray-700 dark:text-white dark:border-gray-600' => $isTailwind && $this->getPerPageFieldAttributes()['default-colors'],
            ])
