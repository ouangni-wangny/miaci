...
@if ($isTailwind)
    <div class="@if ($this->getColumnSelectIsHiddenOnMobile()) hidden sm:block @elseif ($this->getColumnSelectIsHiddenOnTablet()) hidden md:block @endif w-full md:w-auto">
        <div
        ...
        >
                ...
                <span class="rounded-xl shadow-sm">
                    <button
                        ...
                        {{
                            ...
                            ->class([
                                'inline-flex justify-center px-4 py-2 w-full text-sm font-medium rounded-xl border shadow-sm focus:ring focus:ring-opacity-50' => $this->getColumnSelectButtonAttributes()['default-styling'],
                                'text-gray-700 bg-white border-gray-300 hover:bg-gray-50 focus:border-primary-300 focus:ring-primary-200 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600' => $this->getColumnSelectButtonAttributes()['default-colors'],
                            ])
            ...
            <div
                ...
                class="absolute right-0 z-50 mt-2 w-full rounded-xl divide-y divide-gray-100 ring-1 ring-black ring-opacity-5 shadow-lg origin-top-right md:w-48 focus:outline-none"
            >
                <div class="bg-white rounded-xl shadow-xs dark:bg-gray-700 dark:text-white">
                                ...
                                <input
                                    {{
                                        ...
                                        ->class([
                                            ...
                                            'text-primary-600 border-gray-300 focus:border-primary-300 focus:ring-primary-200 dark:bg-gray-900 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600 dark:focus:bg-gray-600' => $this->getColumnSelectMenuOptionCheckboxAttributes()['default-colors'],
                                        ])
                                        ->except(['default-styling', 'default-colors'])
                                    }}
                                    wire:loading.attr="disabled"
