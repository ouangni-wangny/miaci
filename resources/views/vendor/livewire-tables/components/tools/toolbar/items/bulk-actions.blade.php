    ...
    >
        <button
            {{ 
                ...
                ->class([
                    ...
                    'border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:border-primary-300 focus:ring-primary-200 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600' => $isTailwind && ($this->getBulkActionsButtonAttributes['default-colors'] ?? true),
                    'inline-flex justify-center w-full rounded-xl border shadow-sm px-4 py-2 text-sm font-medium focus:ring focus:ring-opacity-50' => $isTailwind && ($this->getBulkActionsButtonAttributes['default-styling'] ?? true),
        ...
        @if($isTailwind)
            <div
                ...
                class="origin-top-right absolute right-0 mt-2 w-full md:w-48 rounded-xl shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none z-50"
            >
                <div
                    {{ 
                        ...
                        ->class([
                            ...
                            'rounded-xl shadow-xs' => $isTailwind && ($this->getBulkActionsMenuAttributes['default-styling'] ?? true),
                        ])
                        ->except(['default','default-styling','default-colors']) 
                    }}
                >
