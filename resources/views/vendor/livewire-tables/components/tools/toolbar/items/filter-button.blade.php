            ...
            <button
                ...
                {{
                    ...
                    ->class([
                        ...
                        'inline-flex justify-center w-full rounded-xl border shadow-sm px-4 py-2 text-sm font-medium focus:ring focus:ring-opacity-50' => $isTailwind && ($this->getFilterButtonAttributes['default-styling'] ?? true),
                        'border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:border-primary-300 focus:ring-primary-200 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600' => $isTailwind && ($this->getFilterButtonAttributes['default-colors'] ?? true),
                    ])
                ...
                @if ($count = $this->getFilterBadgeCount())
                    <span {{
                            ...
                            ->class([
                                ...
                                'bg-primary-100 text-primary-800 dark:bg-primary-200 dark:text-primary-900' => $isTailwind && ($this->getFilterButtonBadgeAttributes['default-colors'] ?? true),
                            ])
                            ->except(['default','default-styling','default-colors'])
                        }}>
                        {{ $count }}
