    ...
    <div x-cloak x-show="filterPopoverOpen"
        {{ 
            ...
            ->class([
                ...
                'origin-top-left absolute left-0 mt-2 rounded-xl shadow-lg ring-1 ring-opacity-5 divide-y focus:outline-none z-50' => $this->getFilterPopoverAttributes['default-styling'] ?? true,
