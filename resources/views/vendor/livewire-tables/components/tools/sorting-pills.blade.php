                    ...
                    <span
                        ...
                        {{
                            ...
                            ->class([
                                ...
                                'bg-primary-100 text-primary-800 dark:bg-primary-200 dark:text-primary-900' => $this->getSortingPillsItemAttributes()['default-colors'],
                            ])
                        ...
                        <button
                            ...
                            {{
                                ...
                                ->class([
                                    ...
                                    'text-primary-400 hover:bg-primary-200 hover:text-primary-500 focus:bg-primary-500 focus:text-white' => $this->getSortingPillsClearSortButtonAttributes()['default-colors'],
                                ])
                                ->except(['default-styling', 'default-colors'])
                            }}
                        >
