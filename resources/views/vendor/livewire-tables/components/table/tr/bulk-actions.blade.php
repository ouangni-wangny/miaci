...
@if ($this->bulkActionsAreEnabled() && $this->hasBulkActions())
    ...
    <x-livewire-tables::table.tr.plain
        ...
        @class([
            'bg-primary-50 dark:bg-gray-900 dark:text-white' => $isTailwind,
        ])
    >
                    ...
                    <button
                        ...
                        {{ 
                            $this->getBulkActionsRowButtonAttributesBag->class([
                                ...
                                'text-primary-600 text-gray-700 focus:text-gray-800 dark:text-white dark:hover:text-gray-400' => $isTailwind && ($this->getBulkActionsRowButtonAttributes['default-colors'] ?? true),
