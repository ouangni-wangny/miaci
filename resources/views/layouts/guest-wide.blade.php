...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen bg-gradient-to-br from-primary-50 to-primary-100 dark:from-gray-900 dark:to-gray-800 flex flex-col items-center justify-center p-4 py-10">
            <div class="w-full max-w-2xl">
                ...
                <div class="w-full px-6 py-8 sm:px-10 bg-white dark:bg-gray-800 shadow-xl rounded-2xl">
                    {{ $slot }}
                </div>
            </div>
        </div>
