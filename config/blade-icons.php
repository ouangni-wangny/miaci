    ...
    */
    ...
    'components' => [
        ...
        */
        ...
        // Le composant générique s'appelle « icon » par défaut (<x-icon>), ce qui
        // masquait le composant maison resources/views/components/icon.blade.php
        // (menu, accueil...). Les icônes Heroicons des DataTables restent
        // disponibles sous leurs propres noms (<x-heroicon-o-funnel>...).
        'default' => 'blade-icon',
